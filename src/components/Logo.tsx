...
// SalesOS Elite brand mark: a six-petal pinwheel (one petal drawn once,
// rotated 60° five times), the same mark as the login screen's
// BrandMark, just without the wordmark — sized for compact use
// (sidebar header, favicons, mobile header).
